                  ...
                  <div key={index} className="col-md-4 mb-4">
                    <div className="card h-100">
                      <div className="card-body d-flex flex-column">
                        ...
                        <p className="text-muted">KES {servicePrices[selectedSubject.name].toLocaleString()}</p>
                        <Link
                          to="/make-payment"
                          state={{
                            service: {
          ...
          <div className="row text-center text-md-start">
            ...
            <div className="col-md-4 mb-3">
              ...
              <div className="d-flex justify-content-center justify-content-md-start gap-2 mt-2">
                ...
                <span className="ms-2">Instagram@EssayGenie</span> 
                <img src="/assets/images/x.png" alt="Twitter" height="24" />
                <span className="ms-2">X@EssayGenie</span>
              </div>
            </div>
          </div>
